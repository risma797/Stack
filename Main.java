...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // seeder
        playlists.push(new Playlist("Way back home", "Shaun"));
        playlists.push(new Playlist("Wish you were here", "Avril Lavigne"));
        playlists.push(new Playlist("Memories", "Maroon 5"));
        // end seeder
